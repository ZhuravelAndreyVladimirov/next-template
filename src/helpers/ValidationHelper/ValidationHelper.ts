export class ValidationHelper {
   ...
   */
  static isEmpty(value: string | number | undefined | null): boolean {
  ...
  static maxLen(len: number, value: string | number): boolean {
  ...
  static minLen(len: number, value: string | number): boolean {
    return len > String(value).length;
  }
  /**
   *
