 ...
 *
 * Этот файл предназначен исключительно для конфигурации Mantine и демонстрации компонента Rating.
 * Для использования компонента Rating в приложении импортируйте его только из библиотеки Mantine:
 *
 *   import { Rating } from '@mantine/core';
 *
 * Не импортируйте ничего из src/extends/Rating/Rating.ts — это приведёт к ошибкам и нарушению архитектуры.
 *
...
export const UiRating = Rating.extend({
  classNames() {
